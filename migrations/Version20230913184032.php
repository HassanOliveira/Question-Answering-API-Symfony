 ...
 */
final class Version20230913184032 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE answer (id INT NOT NULL, channel VARCHAR(255) NOT NULL, body VARCHAR(500) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE question (id INT NOT NULL, title VARCHAR(100) NOT NULL, promoted BOOLEAN NOT NULL, status VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE question_answer (id INT NOT NULL, question_id INT NOT NULL, answer_id INT NOT NULL, PRIMARY KEY(id))');
